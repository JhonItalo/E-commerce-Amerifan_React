               ...
               <S.Content>
                    ...
                    <S.Form>
                         ...
                         <S.Item>
                              ...
                              <p className="legend">necessário pra identificar a maioridade, no formato DD/MM/AAAA</p>
                              <S.Input
                                   width="30%"
                                   active={activeDate}
                                   type="text"
                    ...
                    <p style={{ marginTop: "2rem" }}>
                         Não se preocupe, nosso site é seguro! Ao criar o seu cadastro, <br /> você concorda com a nossa&nbsp;
